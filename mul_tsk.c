...
ID cur_tid;  //現行タスクID
static unsigned char disable_dispatch = 0;  //
static unsigned char notStartTaskContext = 1;
...
ER rot_rdq( void )
{
  ...
  if( disable_dispatch != 0 ) return E_OK;
